...
echo'"AND"'; echo"-Verknüpfung";echo"if";echo"(";echo'$';echo"username == ";echo'"Nils"';echo" && ";echo'$';echo'password == "';echo'php-einfach"';echo")";

echo "Benutzername und Passwort sind korrekt.";echo"}";
